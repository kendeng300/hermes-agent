...
TOOL_USE_ENFORCEMENT_GUIDANCE = (
    ...
    "When quality mandates and throughput mandates conflict, quality wins. Every time.\n"
    "\n"
    ...
    "Every response should either (a) contain tool calls that advance the task "
    ...
    "failures' are NOT blockers when required process steps are in flight. "
    "A missing or incomplete SOUL.md-mandated process artifact (panel review "
    "that never completed, adversarial review that timed out, reviewer that was "
    "never spawned) IS a valid blocker — re-spawn it, wait for it, report the "
    "status. Do NOT ship code with missing process artifacts. "
