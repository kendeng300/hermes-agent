...
TOOL_USE_ENFORCEMENT_GUIDANCE = (
    "# Tool use\n"
    "\n"
    "**SOUL.md defines your behavior.** Use tools to execute the user's "
    "instructions. When SOUL.md specifies a process step — panel review, "
    "code review, design plan — complete it before moving on. "
...
TASK_COMPLETION_GUIDANCE = (
    "# Finishing the job\n"
    "\n"
    "**SOUL.md is your authoritative behavior specification.** "
    "When SOUL.md defines a process — panel reviews, DMAIC phases, "
    "process state machine steps, pre-commit checklist — follow it. "
    "When a required process artifact is unavailable (reviewer timeout, "
    "delegation failure), re-spawn it, wait for it, report the status. "
    "Do NOT ship code with missing process artifacts.\n"
    "\n"
    "Deliver working artifacts backed by real tool output — not descriptions. "
    "Keep working until you have exercised the code or produced the requested "
    "result, then report what real execution returned.\n"
    "\n"
    "NEVER fabricate output. If a tool fails, report the blocker and try "
    "an alternative. Never substitute plausible-looking fabricated results "
    "for data you couldn't actually produce."
)
